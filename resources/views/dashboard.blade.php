            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/2">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        ...
                        <div class="text-gray-500">Bugs</div>
                    </div>
                </div>
            </div>
                    ...
                    @if($bugs)
                        @foreach ($bugs as $bug)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">{{$bug->status ? 'Done' : "Not Done"}}</span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                    <a href="#" class="text-indigo-600 hover:text-indigo-900">{{$bug->status ? '' : "Mark as Resolved"}}</a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
