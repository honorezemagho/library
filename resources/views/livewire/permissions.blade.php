<div class="container mx-auto mt-2">
    <div>
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <x-jet-button wire:click="showCreatePermissionModal" class=" mr-2 text-center bg-blue-800">Add New Permission</x-jet-button>
            ...
            <tr>
                ...
                <td class="border-b w-5">
                    <div  x-data="{ isTouch: false }" class="flex sm:justify-center items-center">
                        <a x-on:click.prevent wire:click="showEditPermissionModal({{ $permission->id }})" @touchstart.prevent="isTouch = true" class="flex items-center text-theme-4 mr-3" href="">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg> Edit
                        </a>
                        <a x-on:click.prevent wire:click="showDeletePermissionModal({{ $permission->id }})" class="flex items-center text-theme-6" href="">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
       ...
       <div class="space-y-8 divide-y divide-gray-200 mt-10">
            <form>
                ...
                <div class=" mt-2 sm:col-span-12">
                    ...
                    <div class="mt-1">
                    <input type="text" id="guard_name" wire:model.lazy="guard_name" name="guard_name" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>
