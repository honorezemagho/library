<template>
    <div class="container mx-auto pt-16">
        ...
        <div class="cursor-pointer flex justify-center pt-4 pb-8 sm:pt-8 md:pt-8 lg:pt-8 xl:pt-12">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-right" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#CBD5E0" fill="none" stroke-linecap="round" stroke-linejoin="r<template>
    <div class="container mx-auto pt-16">
        <div class="pb-12">
            <h1 class="text-3xl xl:text-4xl font-semibold text-gray-800 mx-auto text-center">Testimonials</h1>
            <div class="w-32 mx-auto pt-3 border-b-2 animate-pulse  border-blue-800 text-center mb-4"></div>
