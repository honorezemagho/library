<template>
  <app-layout>
    <InnerPageHero image-url="/dist/images/banner-book-details.png" title="Physical Library" />
    <div class="text-xl container text-center mx-auto px-4 sm:px-0 py-8 sm:py-10">
          Welcome to <span class="text-gray-900">the Physical<span class="text-gray-800">Library</span></span> Works collection ! Some Works can be freely reserved.
    </div>
